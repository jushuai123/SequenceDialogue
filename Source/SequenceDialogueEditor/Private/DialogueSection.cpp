...
TSharedRef<SWidget> FDialogueSection::GenerateSectionWidget()
{
	return
		...
		.OnDropped(this, &FDialogueSection::OnDrop)//.OnDrop( this, &FDialogueSection::OnDrop )
		.Content()
		[
			SNew( SBorder )
...
FReply FDialogueSection::OnDrop(const FGeometry& InGeometry, const FDragDropEvent& InDragDropEvent)
{
